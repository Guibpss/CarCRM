...
namespace CarCRM.Migrations
{
    ...
    [Migration("20260921074117_ValorDecimalServicoPagamento")]
    partial class ValorDecimalServicoPagamento
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CarCRM.Models.ServicoTipo", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarCRM.Models.Veiculo", b =>
                {
                    ...
                    b.Property<int>("VeiculoCombustivelId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("VeiculoMotorizacaoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("VeiculoMotorizacaoId");
            ...
            modelBuilder.Entity("CarCRM.Models.VeiculoCombustivel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarCRM.Models.VeiculoMotorizacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarCRM.Models.VeiculoTransmissao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("VeiculoTransmissao");
                });

            modelBuilder.Entity("CarCRM.Models.VeiculoVersao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CarCRM.Models.Servico", b =>
                {
                    ...
                    b.HasOne("CarCRM.Models.ServicoTipo", "ServicoTipo")
                        .WithMany()
            ...
            modelBuilder.Entity("CarCRM.Models.Usuario", b =>
                {
                    ...
                    b.HasOne("CarCRM.Models.PessoaFisica", "Pessoa")
                        .WithMany()
                        .HasForeignKey("PessoaId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CarCRM.Models.Veiculo", b =>
                {
                    b.HasOne("CarCRM.Models.VeiculoCombustivel", "VeiculoCombustivel")
                        .WithMany()
                        .HasForeignKey("VeiculoCombustivelId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("CarCRM.Models.VeiculoModelo", "VeiculoModelo")
                        .WithMany()
                        .HasForeignKey("VeiculoModeloId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("CarCRM.Models.VeiculoMotorizacao", "VeiculoMotorizacao")
                        .WithMany()
                        .HasForeignKey("VeiculoMotorizacaoId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.HasOne("CarCRM.Models.VeiculoTransmissao", "VeiculoTransmissao")
                        .WithMany()
                    ...
                    b.Navigation("VeiculoMotorizacao");
