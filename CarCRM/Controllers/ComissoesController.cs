...
public class ComissoesController : Controller
{
    ...
    public ComissoesController(CarCRMContext context)
    {
        _context = context;
    }
    ...
    public async Task<IActionResult> Create([Bind("Percentual,FuncionarioId,Funcionario,VendaId,Venda,StatusComissaoId,StatusComissao,PagamentoId,Pagamento,Id,CriadoEm,Excluido")] Comissao comissao)
    {
    ...
    [HttpPost]
    [ValidateAntiForgeryToken]
    public async Task<IActionResult> Edit(int? id, [Bind("Percentual,FuncionarioId,Funcionario,VendaId,Venda,StatusComissaoId,StatusComissao,PagamentoId,Pagamento,Id,CriadoEm,Excluido")] Comissao comissao)
    {
        if (id != comissao.Id)
        {
            return NotFound();
